    ...
    data: [
        {
            ...
            change_criticals: "14",
            total_cases: "1439809",
            total_fatalities: "26692",
            total_vaccinated: "23806038"
        }
    ]
}
...
test('renders <Provinces>', async () => {
    ...
    //check if Nova Scotia is present as a province
    expect(getByText('Nova Scotia')).toBeTruthy()
...
test('renders <Territories>', async () => {
    ...
    expect(getByText('Northwest Territories')).toBeTruthy()
